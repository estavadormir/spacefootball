...
export default async function handlePlayer(params: string, value: string) {
    ...
    let json: Player[] = csvToJson.fieldDelimiter(',').getJsonFromCsv(csvDirectory + '/england-premier-league-players-2018-to-2019-stats.csv')
